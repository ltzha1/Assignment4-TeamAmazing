...
```{r FigRefplot,fig.width=500, fig.cap = "Vaccination Rates Over Time", warning = FALSE, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=15}
   ggplot(vaccine_long,
...
```{r FigRefz, fig.align = "center",fig.cap = "Increase in vaccination coverage over time",message=FALSE, warning=FALSE, fig.height=10, fig.width=15}
ggplot(vaccine_long,
       aes(x = date,
