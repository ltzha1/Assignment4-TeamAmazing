...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{transmission }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"Data/National.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{transmission }\OtherTok{\textless{}{-}}\NormalTok{ transmission }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{date =} \FunctionTok{as.Date}\NormalTok{(date, }\StringTok{\textquotesingle{}\%d{-}\%b\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{transmission\_long }\OtherTok{\textless{}{-}}\NormalTok{ transmission }\SpecialCharTok{\%\textgreater{}\%} 
...
\NormalTok{dates }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(}\FunctionTok{sort}\NormalTok{(transmission\_long}\SpecialCharTok{$}\NormalTok{date)) }
\NormalTok{transmission\_long}\SpecialCharTok{$}\NormalTok{date }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(transmission\_long}\SpecialCharTok{$}\NormalTok{date, }\AttributeTok{ordered =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
