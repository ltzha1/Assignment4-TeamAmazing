...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rec\_clean }\OtherTok{\textless{}{-}}\NormalTok{ rec }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{date =} \FunctionTok{as.Date}\NormalTok{(date, }\StringTok{\textquotesingle{}\%d{-}\%b\textquotesingle{}}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{date =} \FunctionTok{str\_replace\_all}\NormalTok{(date, }\StringTok{"2021"}\NormalTok{, }\StringTok{"2020"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{date =} \FunctionTok{as.Date}\NormalTok{(date, }\StringTok{\textquotesingle{}\%Y{-}\%m{-}\%d\textquotesingle{}}\NormalTok{)) }

\NormalTok{  date }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(}\FunctionTok{sort}\NormalTok{(rec}\SpecialCharTok{$}\NormalTok{date))}
\NormalTok{  rec}\SpecialCharTok{$}\NormalTok{date }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(rec}\SpecialCharTok{$}\NormalTok{date, }\AttributeTok{ordered =}\NormalTok{ T)}
  
\NormalTok{rec\_clean[}\FunctionTok{is.na}\NormalTok{(rec\_clean)] }\OtherTok{\textless{}{-}} \DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rec\_tidy }\OtherTok{\textless{}{-}}\NormalTok{  rec\_clean }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(}\FunctionTok{str\_detect}\NormalTok{(date, }\StringTok{"{-}01"}\NormalTok{))}

\NormalTok{rec\_tab }\OtherTok{\textless{}{-}}\NormalTok{ rec\_tidy  }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(date) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(Recoveries)}
\end{Highlighting}
\end{Shaded}
