...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ vaccine\_long }\OtherTok{\textless{}{-}}\NormalTok{ vaccine}\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{dates }\OtherTok{\textless{}{-}} \FunctionTok{unique}\NormalTok{(}\FunctionTok{sort}\NormalTok{(vaccine\_long}\SpecialCharTok{$}\NormalTok{date))}
\NormalTok{vaccine\_long}\SpecialCharTok{$}\NormalTok{date }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(vaccine\_long}\SpecialCharTok{$}\NormalTok{date,}\AttributeTok{ordered=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
